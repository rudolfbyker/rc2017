...
def extract_camera_audio(name):
    ...
    camera_video_filename = os.path.join(parameters['output_folder'], '{}_camera.mp4'.format(name))  # generated by `concatenate_camera_clips_for_talk`
    output_wav_filename = os.path.join(parameters['output_folder'], '{}_camera.wav'.format(name))
...
def make_talk_video(name, crf=crf_visually_lossless, preset='slow'):
    ...
    slide_video_filename = os.path.join(parameters['output_folder'], '{}_slides.mp4'.format(name))  # generated by `make_slide_video_for_talk`
    camera_video_filename = os.path.join(parameters['output_folder'], '{}_camera.mp4'.format(name))  # generated by `concatenate_camera_clips_for_talk`
